...
class UserRPC : public ::PROTOBUF_NAMESPACE_ID::Service {
 protected:
 ...
 private:
  GOOGLE_DISALLOW_EVIL_CONSTRUCTORS(UserRPC);
};

class UserRPC_Stub : public UserRPC {
 public:
  UserRPC_Stub(::PROTOBUF_NAMESPACE_ID::RpcChannel* channel);
  UserRPC_Stub(::PROTOBUF_NAMESPACE_ID::RpcChannel* channel,
 ...
 private:
  ...
  bool owns_channel_;
  GOOGLE_DISALLOW_EVIL_CONSTRUCTORS(UserRPC_Stub);
};
...
// int32 errid = 1;
inline void ResultCode::clear_errid() {
  errid_ = 0;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 ResultCode::_internal_errid() const {
  return errid_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 ResultCode::errid() const {
  // @@protoc_insertion_point(field_get:fixbug.ResultCode.errid)
  return _internal_errid();
}
inline void ResultCode::_internal_set_errid(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  errid_ = value;
}
inline void ResultCode::set_errid(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_errid(value);
  // @@protoc_insertion_point(field_set:fixbug.ResultCode.errid)
}
